...
/************************modified S**********************/
    //std::cout << "In foundResource\n";
	    ...
	    if(resourceURI.compare("/oic/d")==0||resourceURI.compare("/oic/p")==0||resourceURI.compare("/oic/sec/doxm")==0||resourceURI.compare("/oic/sec/pstat")==0)
		{
		return;
		}
        ...
        if(resource)
        {
            ...
            if(resourceURI == "/a/light")
            {
                if (resource->connectivityType() & TRANSPORT_TYPE_TO_USE)
                {
                    ...
                    //getLightRepresentation(resource);         //modified
                }
            }
        }
        else
