 ...
 */
//............................................................................
static void callbackMessageReceived(struct mosquitto *pMsqt,
                                     void * context,
 ...
 */
//............................................................................
static void callbackDisconnected(mosquitto *pMsqt,
                                 void * context,
                                 int32_t a) {
    RaspberryOSIOClient * _this = (RaspberryOSIOClient *)context;
...
void RaspberryOSIOClient::initialize(char * userName, 
    ...
    this->_data = mosquitto_new(deviceId,1, this);
...
bool RaspberryOSIOClient::connectIfNecessary() {
    ...
    int32_t result = mosquitto_connect(this->_data, this->_serverName, MQTT_PORT, 60);
...
bool RaspberryOSIOClient::publish(char* topic, char* payload)  {
    ...
    int32_t result = mosquitto_publish(this->_data, 0, topic, strlen(payload), (const void*)payload, 0, false);
...
bool RaspberryOSIOClient::subscribe(char* topic) {
    ...
    int32_t result = mosquitto_subscribe(this->_data, 0, topic, 0);
    return result == MOSQ_ERR_SUCCESS;
}
//............................................................................
/*
...
bool RaspberryOSIOClient::loop() {
    ...
    int32_t result = mosquitto_loop(this->_data, -1,1);
    return result == MOSQ_ERR_SUCCESS;
}
//............................................................................
/*
