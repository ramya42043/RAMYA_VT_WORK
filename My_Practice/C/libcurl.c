...
int main(void)
{
  ...
  if(curl) {
    ...
    curl_easy_setopt(curl, CURLOPT_USERNAME, "ashashishpoojala");
    curl_easy_setopt(curl, CURLOPT_PASSWORD, "ashoksivakumar");

    /* This is mailbox folder to select */
    curl_easy_setopt(curl, CURLOPT_URL, "imap://imap.gmail	.com/INBOX");
