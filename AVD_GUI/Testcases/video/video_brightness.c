...
/*static char* display_status(CustomData *data,gint flag)
{

	gdouble lcontr,lbright,lhue_var,lsatur;
	g_object_get(data->vidbalance,"brightness",&lbright,NULL);
	if(bright==lbright)
		return "Pass";
	else
		return "Fail";
...
gint start()
{
	...
	p=change_brightness(&data,-0.8000011122141);
